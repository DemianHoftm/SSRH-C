...
namespace SRRH
{
    class DBAccess
    {
        ...
        public SqlConnection Con { get { return connection; } set { connection = value; } }

        private static string strConnString = "Data Source=(local);Initial Catalog=SRRH;Integrated Security=True";
